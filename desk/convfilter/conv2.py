...
# initial weights
w_shape = (3,3,9,9) #2 convolutional filters, 3 channels, filter shape: 9*9
...
#output = T.nnet.sigmoid(conv_out + b(0,'x'))
...
img3 = numpy.asarray(img3, dtype = 'float32')/256. # (height, width, 3)

# put image in 4D tensor of shape (1,3,height,width)
img3_rgb = img3.swapaxes(0,2).swapaxes(1,2).reshape(1,3,height1,width1) #(3,height,width)
