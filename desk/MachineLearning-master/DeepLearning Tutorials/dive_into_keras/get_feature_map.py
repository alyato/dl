...
model = cPickle.load(open("/home/hey/Downloads/model.pkl","rb"))

#define theano funtion to get output of  FC layer
get_feature = theano.function(
...
#get one image from data  such as data[0]
feature=get_feature(data[0:10])
...
#define the feature_map = 16 because the last conv_layer in the cnn.py has 16 featureMaps
#num_fmap=16
#for i in range(num_fmap):
